...
public class YukiMaintainerPreferenceController extends BasePreferenceController {
    ...
    public int getAvailabilityStatus() {
        return !TextUtils.isEmpty(SystemProperties.get(ALRIGHT_MAINTAINER_PROPERTY)) ? AVAILABLE : UNSUPPORTED_ON_DEVICE;
    }

    @Override
    public CharSequence getSummary() {
        return SystemProperties.get(ALRIGHT_MAINTAINER_PROPERTY,
